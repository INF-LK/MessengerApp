...
class FrontendGUI(Tk):
    ...
    def openChat(self, contact, newContact=False):
        ...
        bubbleFrame = tk.Frame(chatCanvas, bg=self.windowColor)
        chatCanvas.create_window((0, 0), window=bubbleFrame, anchor="nw",width=1020, height=969)
    ...
    def getContacts(self, username = None, login=False):
    ...
    def updateLoop(self):
        ...
        self.after(500, self.updateLoop)  # Check for new messages 
